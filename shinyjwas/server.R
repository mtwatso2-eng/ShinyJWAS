...
server = shiny::shinyServer(function(input, output, session) {
  ...
  observeEvent(input$help,{
    ...
    } else if (str_contains(input$tabs,"posterior_distribution")) {
      rintrojs::introjs(session, options = list(
    ...
    } else if (str_contains(input$tabs,"venn_diagram")) {
      rintrojs::introjs(session, options = list(
    ...
    } else if (str_contains(input$tabs,"julia_script")) {
      rintrojs::introjs(session, options = list(
    ...
    }  else if (str_contains(input$tabs,"manhattan_plot")) {
      rintrojs::introjs(session, options = list(
        steps = data.frame(element = c(
          "#sixth_sample_data",
    ...
    } else if (str_contains(input$tabs,"convergence_diagnosis")) {
      rintrojs::introjs(session, options = list(
        steps = data.frame(element = c(
          "#seventh_sample_data",
  ...
  # download sample file and example
